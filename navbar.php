      ...
      <span class="navbar-toggle" id="js-navbar-toggle">
        ...
        <ul class="main-nav " id="js-menu">
            ...
            <li id="meniu" class="right nu"><input type="text" placeholder="     Cauta in magazin...">
                <button type="submit" name="header_search_submit" class="button-reset color-inherit db o-60 absolute center-v right-1 hover-primary6" style="border: none; background-color: white; font-size: 18px; position:absolute; right: 200px; top:55px; color: #8E78FF ">
